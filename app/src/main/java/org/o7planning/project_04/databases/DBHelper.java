...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public boolean checkTableExist(String tableName) {
        ...
        try {
            ...
            Log.e("DBHelper", "Error checking table existence: " + e.getMessage());
            return false;
        } finally {
    ...
    public List<category> getAllCategories(String LoaiDM) {
        ...
        Log.d("categoryfragment", "Cursor count = " + cursor.getCount());
    ...
    public boolean deleteCategory(int id, Context context) {
        ...
        if (cate != null && cate.getDMMacDinh() == 1) {
            Toast.makeText(context, "Không thể xóa danh mục mặc định", Toast.LENGTH_SHORT).show();
    ...
    // Truy vấn giao dich theo nhóm danh mục
...
//Ktra lai dịnh dạng ThoiGian trong bảng GiaoDịch khi truy vấn
        String query = "Select DANHMUC.TenDM,SUM(GIAODICH.SoTien) as TongTien From GIAODICH Inner join DANHMUC on GIAODICH.ID_DM = DANHMUC.ID_DM Where DANHMUC.LoaiDM =? And ThoiGian between ? And ? Group by DANHMUC.TenDM";
    ...
    public boolean insertLimit(Limit l) {
        ...
        try {
            ...
            values.put("NgayGD", l.getNgayGD());
            values.put("NgayKetThuc", l.getNgayKetThuc());
